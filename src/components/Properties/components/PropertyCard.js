...
import GalleryCarousel from '@/components/Carousel/ImageGallery/GalleryCarousel';
import InfoSection from '@/components/Modal/InfoSection';
    ...
    <>
      <div
        className={`${isList
          ...
          : 'w-full'
          } bg-white border rounded-xl border-gray-200 hover:cursor-pointer hover:shadow-xl transition duration-300 ease-in-out`}
      >
        <img
          className={`${isList
